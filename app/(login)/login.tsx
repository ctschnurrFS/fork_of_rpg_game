...
export function Login({ mode = "signin" }: { mode?: "signin" | "signup" }) {
  ...
  const backgroundImageUrl = '/images/castle_courtyard_crop.png';
  const overlayColor = 'rgba(31, 41, 55, 0.6)';

  return (

    // Apply background image, overlay, size, position, and min-height here
    <div
      className="flex min-h-screen items-center justify-center bg-cover bg-center p-4"
      // Use inline style for the composite background-image property
      // This layers a semi-transparent color gradient over your image url
      style={{
